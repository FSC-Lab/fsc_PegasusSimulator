...
#   │  application/robotic_arm/controller.py  (run under /uav_0 ns)      │
#   │    subscribes state/pose, state/twist*, joint_states               │
#   │    publishes  rotor_velocity_command, joint_torque_cmd            │
#   └────────────────────────────────────────────────────────────────────┘
#
# Usage:
#   ./scripts/start_aerial_manipulator.sh <config_name>
#   e.g. ./scripts/start_aerial_manipulator.sh shiqi_machine
# ============================================================================
